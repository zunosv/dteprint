...
# Total y pagos
    # Cambiamos lr() por una cadena directa para que pegue a la izquierda
...
<div style="text-align:center; margin-top:6px;">
  ...
  <span style="font-size:7pt; color:#333;">Escanea para descargar tu DTE</span>
                ...
                # Fallback: mostrar URL pequeña si qrcode no está
                qr_html = f'<div style="font-size:6pt;word-break:break-all;margin-top:4px;">{htmlmod.escape(url_qr)}</div>'
...
<body><pre>{ticket_txt}</pre>{qr_html}</body></html>"""
